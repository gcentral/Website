 ...
 */
final class Version20210413045443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE package_version CHANGE deps_string deps_string LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', CHANGE icon_url icon_url VARCHAR(255) DEFAULT NULL, CHANGE license license VARCHAR(255) NOT NULL');
    }
