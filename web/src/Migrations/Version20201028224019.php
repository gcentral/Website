 ...
 */
final class Version20201028224019 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE developer_group ADD display_name VARCHAR(255) NOT NULL, CHANGE personal_user_id personal_user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE package CHANGE icon_url icon_url VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE package_repo CHANGE last_update last_update DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE developer_group DROP display_name, CHANGE personal_user_id personal_user_id INT DEFAULT NULL');
