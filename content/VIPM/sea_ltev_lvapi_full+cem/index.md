---
title: "SEA LTE-V Add-On for LabVIEW - FULL+CEM API"
externalUrl: https://www.vipm.io/package/sea_ltev_lvapi_full+cem
date: 2022-03-04
...
Redirecting to https://www.vipm.io/package/sea_ltev_lvapi_full+cem
...
Full Description:
The **SEA LTE-V Add-On for LabVIEW - FULL API** delivers a suite to build V2X (Vehicle-To-Anything) related applications in LabVIEW based on LTE technlogies (3GPP TS 36.300). This package provides: (1) MON functions palette (API) for monitoring and timing manipulation, (2) RFC functions palette (API) for measurement and validation of RF-signals, (3) Host Control Manager (HCM-FULL+CEM) as abstraction layer beween the APIs and the local V2X communication hardware, (4) examples, (5) user documentation.
