---
title: "SEA LTE-V Add-On for LabVIEW - RF-COMPLIANCE+CEM API"
externalUrl: https://www.vipm.io/package/sea_ltev_lvapi_rfc+cem
summary: "The **SEA LTE-V Add-On for LabVIEW - RF-COMPLIANCE API** delivers a suite to build V2X (Vehicle-To-Anything) related applications in LabVIEW based on LTE technlogies (3GPP TS 36.300)."
showSummary: true
showAuthor: false
showEdit: false
showData: false
...
Redirecting to https://www.vipm.io/package/sea_ltev_lvapi_rfc+cem
...
Full Description:
The **SEA LTE-V Add-On for LabVIEW - RF-COMPLIANCE API** delivers a suite to build V2X (Vehicle-To-Anything) related applications in LabVIEW based on LTE technlogies (3GPP TS 36.300). This package provides: (1) a functions palette (API) for measurement and validation, (2) Host Control Manager (HCM-RFC+CEM) as abstraction layer beween the APIs and the local V2X communication hardware, (3) examples, (4) user documentation.
