...
// National Instruments Copyright 2019
!function(){const e=[];NationalInstruments.HtmlVI.ElementRegistrationService=class{static registerElement(t){e.push(t)}static completeRegistration(){e.forEach(e=>{window.NationalInstruments.HtmlVI.Elements.NIElement._finalizeObservedAttributes(e),window.customElements.define(e.prototype.elementInfo.tagName,e)}),window.NationalInstruments.HtmlVI.Elements.NIElement.notifyElementsRegistered()}}}(),
// National Instruments Copyright 2014
function(){const e=NationalInstruments.HtmlVI.WebApplicationStates,t=NationalInstruments.HtmlVI.NISupport,n=function(){const e=document.createElement("div");e.classList.add("ni-execution-buttons-box");const t=document.createElement("button");t.textContent="Start",t.type="button",t.classList.add("ni-execution-button","ni-start-button","disabled");const n=document.createElement("button");n.textContent="Abort",n.type="button",n.classList.add("ni-execution-button","ni-abort-button","disabled"),e.appendChild(t),e.appendChild(n);return{uiControls:e,startButton:t,abortButton:n,enableButtons:function(e,i){e?t.classList.remove("disabled"):t.classList.add("disabled"),i?n.classList.remove("disabled"):n.classList.add("disabled")}}},i=function(e,t){"READY"===t?e.enableButtons(!0,!1):"RUNNING"===t||"CONNECTING"===t||"CONNECTED"===t||"LISTENING"===t?e.enableButtons(!1,!0):e.enableButtons(!1,!1)},a=function(e){"CONNECTED"===e?t.info("CONNECTED"):t.info("CONNECTING")};class r extends NationalInstruments.HtmlVI.Elements.NIElement{addAllProperties(t){super.addAllProperties(t);const n=r.prototype;n.addProperty(t,{propertyName:"engine",defaultValue:""}),n.addProperty(t,{propertyName:"location",defaultValue:""}),n.addProperty(t,{propertyName:"vireoSource",defaultValue:""}),n.addProperty(t,{propertyName:"wasmUrl",defaultValue:""}),n.addProperty(t,{propertyName:"remoteAddress",defaultValue:""}),n.addProperty(t,{propertyName:"testMode",defaultValue:!1}),n.addProperty(t,{propertyName:"disableAutoStart",defaultValue:!1}),n.addProperty(t,{propertyName:"serviceState",defaultValue:e.ServiceStateEnum.UNINITIALIZED,fireEvent:!0}),n.addProperty(t,{propertyName:"maximumErrorMessageCount",defaultValue:100})}createdCallback(){super.createdCallback(),this._enableConnectionDialog=!1,this._frontEndElements=void 0,this.serviceState=e.ServiceStateEnum.UNINITIALIZED}attachedCallback(){const e=super.attachedCallback(),r=this;let s;return t.logVerbose("ni-web-application attachedCallback() firstCall="+e+" disableAutoStart="+r.disableAutoStart+" engine="+r.engine+" location="+r.location),NationalInstruments.HtmlVI.webApplicationModelsService.register(r),!0===e&&(!1===r.disableAutoStart&&"NATIVE"===r.engine&&"BROWSER"===r.location&&(r._enableConnectionDialog=!0,a(r.serviceState)),!0===r.disableAutoStart&&((s=n()).startButton.addEventListener("click",function(){!1===s.startButton.classList.contains("disabled")&&r.start()}),s.abortButton.addEventListener("click",function(){!1===s.abortButton.classList.contains("disabled")&&r.stop()}),r._frontEndElements=s,i(r._frontEndElements,r.serviceState),r.appendChild(s.uiControls))),e}propertyUpdated(e){switch(super.propertyUpdated(e),e){case"serviceState":!0===this._enableConnectionDialog&&a(this.serviceState),!0===this.disableAutoStart&&i(this._frontEndElements,this.serviceState)}}detachedCallback(){NationalInstruments.HtmlVI.webApplicationModelsService.unregister(this)}start(){this.dispatchEvent(new CustomEvent("requested-start",{bubbles:!0,cancelable:!0,detail:{element:this}}))}stop(){this.dispatchEvent(new CustomEvent("requested-stop",{bubbles:!0,cancelable:!0,detail:{element:this}}))}}NationalInstruments.HtmlVI.ElementRegistrationService.registerElement(r),NationalInstruments.HtmlVI.Elements.NIElement.defineElementInfo(r.prototype,"ni-web-application","HTMLNIWebApplication"),NationalInstruments.HtmlVI.Elements.WebApplication=r}(),
// National Instruments Copyright 2014
function(){class e extends NationalInstruments.HtmlVI.Elements.NIElement{addAllProperties(t){super.addAllProperties(t);const n=e.prototype;n.addProperty(t,{propertyName:"viName",defaultValue:""}),n.addProperty(t,{propertyName:"viRef",defaultValue:""})}attachedCallback(){const e=super.attachedCallback();return NationalInstruments.HtmlVI.viReferenceService.registerVIElement(this),e}detachedCallback(){NationalInstruments.HtmlVI.viReferenceService.unregisterVIElement(this)}}NationalInstruments.HtmlVI.ElementRegistrationService.registerElement(e),NationalInstruments.HtmlVI.Elements.NIElement.defineElementInfo(e.prototype,"ni-virtual-instrument","HTMLNIVirtualInstrument"),NationalInstruments.HtmlVI.Elements.VirtualInstrument=e}(),
// National Instruments Copyright 2014
function(){class e extends NationalInstruments.HtmlVI.Elements.NIElement{addAllProperties(t){super.addAllProperties(t);const n=e.prototype;n.addProperty(t,{propertyName:"disabled",defaultValue:!1}),n.addProperty(t,{propertyName:"niControlId",defaultValue:""}),n.addProperty(t,{propertyName:"viRef",defaultValue:""}),n.addProperty(t,{propertyName:"followerIds",defaultValue:"[]"})}createdCallback(){super.createdCallback(),this._latestSize={width:void 0,height:void 0},this._temporaryModelSettingsHolder=void 0}attachedCallback(){const e=this;let t;!0!==e._preventModelCreation&&(t=NationalInstruments.HtmlVI.viReferenceService.getVIViewModelByVIRef(e.viRef)).attachElementToModelAndViewModel(e);const n=super.attachedCallback();return n&&e.addEventListener("resizeEventHack",function(t){const n=parseInt(t.detail.width),i=parseInt(t.detail.height);e._latestSize.width===n&&e._latestSize.height===i||(e._latestSize.height=i,e._latestSize.width=n,e.forceResize(e._latestSize))}),n}detachedCallback(){const e=this;if(!0!==e._preventModelCreation){NationalInstruments.HtmlVI.viReferenceService.getVIViewModelByVIRef(e.viRef).detachElementFromModelAndViewModel(e)}}forceResize(e){}clearProperties(){this.disabled=!1,this.niControlId="",this.viRef="",this.followerIds="[]"}static defineElementInfo(e,t,n){NationalInstruments.HtmlVI.Elements.NIElement.defineElementInfo(e,t,n),e.attachedCallback=this.generateAttachedCallback(e.attachedCallback)}static generateAttachedCallback(e){return function(){const t=this,n=e.apply(t,arguments),i=NationalInstruments.HtmlVI.viReferenceService.getVIModelByVIRef(t.viRef),a=i.getControlModel(this.niControlId),r=i.getControlViewModel(this.niControlId);return!0!==t._preventModelCreation&&(r.bindToView(),!0===r._needsResizeHack&&t.dispatchEvent(new CustomEvent("resizeEventHack",{detail:{width:a.width,height:a.height}}))),n}}}NationalInstruments.HtmlVI.Elements.VisualComponent=e}(),
// National Instruments Copyright 2014
function(){class e extends NationalInstruments.HtmlVI.Elements.VisualComponent{addAllProperties(t){super.addAllProperties(t);const n=e.prototype;n.addProperty(t,{propertyName:"readOnly",defaultValue:!1}),n.addProperty(t,{propertyName:"bindingInfo",defaultValue:{prop:"",field:"",sync:!1,dco:-1,dataItem:"",accessMode:"",unplacedOrDisabled:!1,isLatched:!1}}),n.addProperty(t,{propertyName:"labelId",defaultValue:""}),n.addProperty(t,{propertyName:"controlResizeMode",defaultValue:""}),n.addProperty(t,{propertyName:"labelAlignment",defaultValue:""})}clearProperties(){super.clearProperties(),this.readOnly=!1,this.bindingInfo={prop:"",field:"",sync:!1,dco:-1,dataItem:"",accessMode:"",unplacedOrDisabled:!1,isLatched:!1},this.labelId="",this.controlResizeMode="",this.labelAlignment=""}setFont(e,t,n,i,a){this.style.fontSize=e,this.style.fontFamily=t,this.style.fontWeight=n,this.style.fontStyle=i,this.style.textDecoration=a}}NationalInstruments.HtmlVI.Elements.Visual=e}(),
// National Instruments Copyright 2015
function(e,t){const n=NationalInstruments.HtmlVI.NISupport,i=NationalInstruments.HtmlVI.StringDisplayModeConstants.TextDisplayMode,a=NationalInstruments.HtmlVI.ValueConverters.StringDisplayModeConverter,r=function(e,t){return t===i.ESCAPED?a.toEscapedDisplayMode(e):e},s=function(e,t){return t===i.ESCAPED?a.toDefaultDisplayMode(e):e};class l extends NationalInstruments.HtmlVI.Elements.Visual{addAllProperties(e){super.addAllProperties(e);const t=l.prototype;t.addProperty(e,{propertyName:"text",defaultValue:"",fireEvent:!0,addNonSignalingProperty:!0}),t.addProperty(e,{propertyName:"acceptsReturn",defaultValue:!1}),t.addProperty(e,{propertyName:"typeToReplace",defaultValue:!1}),t.addProperty(e,{propertyName:"wordWrap",defaultValue:!1}),t.addProperty(e,{propertyName:"escapedDisplayMode",defaultValue:i.DEFAULT}),n.setValuePropertyDescriptor(e,"text","text","textNonSignaling","text-changed")}attachedCallback(){const e=super.attachedCallback();let t;const n=this;let i=!1;return!0===e&&((t=document.createElement("textarea")).classList.add("ni-text-field"),t.value=s(this.text,this.escapedDisplayMode),t.readOnly=this.readOnly,t.disabled=this.disabled,t.wrap=this.wordWrap?"soft":"off",t.addEventListener("change",function(){const e=s(t.value,n.escapedDisplayMode);n.text!==e&&(n.text=e)}),t.addEventListener("click",function(){n.typeToReplace&&!i&&(i=!0,t.focus(),t.select())}),t.addEventListener("blur",function(){const e=s(t.value,n.escapedDisplayMode);i=!1,n.text!==e&&(n.text=e)}),t.addEventListener("keydown",function(e){if((!1===n.acceptsReturn||!0===e.ctrlKey)&&13===e.keyCode)return t.blur(),!1}),this.innerHTML="",this.appendChild(t)),e}propertyUpdated(e){super.propertyUpdated(e);const t=this.firstElementChild;switch(e){case"readOnly":t.readOnly=this.readOnly;break;case"text":t.value=r(this.text,this.escapedDisplayMode);break;case"wordWrap":t.wrap=this.wordWrap?"soft":"off";break;case"disabled":t.disabled=this.disabled;break;case"escapedDisplayMode":t.value=r(this.text,this.escapedDisplayMode)}}}NationalInstruments.HtmlVI.ElementRegistrationService.registerElement(l),NationalInstruments.HtmlVI.Elements.VisualComponent.defineElementInfo(l.prototype,"ni-string-control","HTMLNIStringControl"),NationalInstruments.HtmlVI.Elements.StringControl=l}(),
